...
import { StyledSignUpEmailVerify, StyledSignUpEmailVerifyContainer } from '@/components/ui/signUp/signUpStyled';
...
const SignUpSuccess = () => {
  return (
    <StyledSignUpEmailVerifyContainer>
      <StyledSignUpEmailVerify>
